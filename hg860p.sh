...
# download dan INSTALL ssL ubtuk DEBIAN
run_command "wget http://ports.ubuntu.com/pool/main/o/openssl/openssl_1.1.1f-1ubuntu2_arm64.deb"Installing openssl ($(( ++current_step ))/$total_steps)" 
run_command "wget http://ports.ubuntu.com/pool/main/o/openssl/libssl-dev_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)" 
run_command "wget http://ports.ubuntu.com/pool/main/o/openssl/libssl1.1_1.1.1f-1ubuntu2_arm64.deb"Installing libssli ($(( ++current_step ))/$total_steps)" 

run_command "sudo chmod +x  openssl_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"
run_command "sudo chmod +x  libssl-dev_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"
run_command "sudo chmod +x  libssl1.1_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"
run_command "sudo apt install ./openssl_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"
run_command "sudo apt install ./libssl-dev_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"
run_command "sudo apt install ./libssl1.1_1.1.1f-1ubuntu2_arm64.deb"Installing libssl ($(( ++current_step ))/$total_steps)"

run_command "sudo apt-get install mongodb-org=4.4.10 mongodb-org-database-tools-extra=4.4.10 mongodb-org-mongos=4.4.10 mongodb-org-server=4.4.10 mongodb-org-shell=4.4.10 mongodb-org-tools=4.4.10"Installing mangoDB ($(( ++current_step ))/$total_steps)"
